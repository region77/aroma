...
<head>
  ...
  <title>Магазин Aroma - Главная</title>
            ...
            <ul class="nav navbar-nav menu_nav ml-auto mr-auto">
              ...
              <li class="nav-item submenu dropdown">
                ...
                <ul class="dropdown-menu">
                  <li class="nav-item"><a class="nav-link" href="category.html">Разделы магазина</a></li>
              ...
              <li class="nav-item submenu dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="nav-item"><a class="nav-link" href="single-blog.html">Подробности блога</a></li>
                </ul>
							</li>
							<li class="nav-item submenu dropdown">
                <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
                ...
                <ul class="dropdown-menu">
                  <li class="nav-item"><a class="nav-link" href="/auth">Войти на сайт</a></li>
